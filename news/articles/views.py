...
from django.views.generic.edit import UpdateView, DeleteView, CreateView, FormView # new
...
class ArticleCreateView(LoginRequiredMixin, CreateView): # ORDER OF SUPERCLASSES MATTERS!
    model = Article
